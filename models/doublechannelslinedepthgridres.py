...
from state_encoders.double_channels_line_nngrid import NNGrid as senc_NNGrid
...
class ActorCritic(torch.nn.Module):
    def __init__(self, observation_space, action_space, n_frames, args):
        ...
        self.conv1 = nn.Conv2d(self.frame_stack.n_frames*self.input_size[0], 128, 4, stride=1, padding=1)

...
class FlatNNGrid(torch.nn.Module):
    def __init__(self, args):
        super(FlatNNGrid, self).__init__()
        ...
        self.observation_space = spaces.Box(
            ...
            shape=(args['observation_dim'] + self.grid_edge * self.grid_edge,))
    ...
    def forward(self, inputs):
        ...
        grid_state = torch.zeros(self.grid_edge, self.grid_edge)
        if ob.is_cuda:
        ...
        for j in info['joints']:
            ...
            grid_state[A_grid_x, A_grid_y] = 1.
            grid_state[B_grid_x, B_grid_y] = 1.
        ...
        if self.use_lidar:
            for l in info['lidar']:
                ...
                grid_state[p2_x,p2_y] = 1.

        # Want dimensions [batch_size, num_observations]
